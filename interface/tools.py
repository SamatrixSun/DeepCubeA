...
def getResults(state):
    ...
    parser.add_argument('--model_loc', type=str, default="/home/sy/Documents/workspace/deepcube/deepcube-full-master/code/savedModels/cube3/1", help="Location of model")
